...
const actionsheetContentStyle = tva({
  base: 'items-center rounded-tl-3xl rounded-tr-3xl p-2 bg-black-0 web:pointer-events-auto web:select-none shadow-lg pb-safe',
});

const actionsheetItemStyle = tva({
  base: 'w-full flex-row items-center p-3 rounded-full data-[disabled=true]:opacity-40 active:bg-neutral-900 data-[checked=true]:bg-neutral-900',
});
