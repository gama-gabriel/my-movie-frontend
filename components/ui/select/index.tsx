...
const selectTriggerStyle = tva({
  base: 'border border-neutral-500 rounded-full flex-row items-center overflow-hidden data-[focus=true]:border-primary-700',
  variants: {
    size: {
      xl: 'h-12',
      lg: 'h-11',
...
const selectInputStyle = tva({
  base: 'px-3 placeholder:text-neutral-100 h-full text-white pointer-events-none ios:leading-[0px] py-0',
  parentVariants: {
    size: {
      xl: 'text-xl',
      lg: 'text-lg',
